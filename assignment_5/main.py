...
from assignment_5.model import ResNetHPEModel
...
if __name__ == "__main__":
    ...
    # execute argument heatmap_confirmation
    ...
    # execute argument augmentation_confirmation
