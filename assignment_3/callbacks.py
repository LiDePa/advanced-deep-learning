...
class ModelCheckpoint:
    ...
    def __init__(self: ModelCheckpoint, output_dir: str, metric: Metric, *, filename: str = "") -> None:
    ...
    def checkpoint_if_necessary(self: ModelCheckpoint, to_save: Dict[str, Any], *, filename_suffix: str = "") -> None:
